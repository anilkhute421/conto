		        ...
		        <tr align="center" >
		            <td  style="background-color: #efefef; padding: 0 10px 10px;text-align: left;">
		                ...
		                <p style="font-size:20px; line-height:24px; color:#353535; padding:0px 10px 10px; margin: 0;"> 
							<a href="{{ $emailData['url'] }}" style="font-size:20px; line-height:24px; color:rgb(66 71 244) padding:0px 10px 10px; margin: 0;" href="#"> click here </a> to reset your password
                      </p>
